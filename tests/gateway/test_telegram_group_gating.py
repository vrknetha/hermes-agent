...
def test_group_messages_can_require_direct_trigger_via_config():
    ...
    assert adapter._should_process_message(_group_message("/status@hermes_bot"), is_command=True) is True
    assert adapter._should_process_message(_group_message("/status@otherbot"), is_command=True) is False
